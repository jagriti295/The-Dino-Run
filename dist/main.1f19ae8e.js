...
// const CONTRACT_NAME = process.env.CONTRACT_NAME || 'jsikka3';
var CONTRACT_NAME = "dev-1645411440020-84028642468373" || 'jsikka33.testnet';
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/Users/jsikka", "/.near/validator_key.json"),
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            console.log(window.accountId); // Initializing our contract APIs by contract name and configuration.
            ...
            return window.near.loadContract(nearConfig.contractName, {
              ...
              // viewMethods: ['nft_tokenmeta'],
              // Change methods can modify the state. But you don't receive the returned value when called.
              // changeMethods: ['sayHi', 'nft_transfer', 'nft_mint'],
...
function signedInFlow() {
  ...
  document.getElementById('say-hi').addEventListener('click', function () {
    ...
    var tokenId = "frsttok"; // let meta1 = window.contract.nft_metadata();
    // console.log
    // window.contract.whosaidHi();
    // updateWhoSaidHi();

    var meta = window.contract.sayHi().then(updateWhoSaidHi); // let receiveId = "jsikka3";
    // window.contract.nft_mint(tokenId, meta, receiveId).then(console.log("finished"));
